			...
			<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
					<div class="comment-box">
						...
						<div class="comment-textarea">
							<textarea rows="8" cols="50" name="text" id="textarea" class="textarea comment-textarea" required ><?php $this->remember('text'); ?></textarea>
						</div>
				...
				<div class="comment-author">
					<div class="row comment-row comment-mg">
						<div class="comment-show-con-img">
							...
							<?php $singleCommentOptions->avatarSize = 42; //将头像尺寸改为64 ?>
							<?php }else{ //父回复 ?>
							<?php $singleCommentOptions->avatarSize = 48; //将头像尺寸改为64 ?>
							<?php } ?>
							...
							<div class="row comment-row date-dz">
								<div class="col comment-meta">
									<a href="<?php $comments->permalink(); ?>"><?php $singleCommentOptions->beforeDate();
                                        $comments->date($singleCommentOptions->dateFormat);  //$singleCommentOptions->dateFormat
