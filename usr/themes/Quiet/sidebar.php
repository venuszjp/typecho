...
<div class="col-12 col-lg-3 hidden-md" id="secondary" class="sidebar" role="complementary">
    ...
    <section class="widget paddingall">
        ...
        <div class="side-info-link">
            ...
            <a href="<?php $this->options->siteUrl(); ?>" target="_blank"><i class="fa fa-internet-explorer"
                                                                             aria-hidden="true">&nbsp; </i></a>
        </div>
        <div class="side-info-con">
            <pre class="hitokoto">你若不勇敢，谁能替你坚强！</pre>
        </div>
    </section>
        ...
        <section class="widget paddingall">
            ...
            <ul class="widget-list">
                ...
                <?php while ($comments->next()): ?>
                    <li><span class="avatar"><?php $comments->gravatar(24); ?></span><a
                                href="<?php $comments->permalink(); ?>"><?php $comments->author(false); ?></a>: <?php $comments->excerpt(28, '...'); ?>
                    </li>
                <?php endwhile; ?>
            </ul>
        </section>
